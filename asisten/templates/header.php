...
<div class="flex h-screen">
        ...
        <nav class="flex-grow">
            <ul class="space-y-2 p-4">
                <?php
                    ...
                    $activeClass = 'bg-purple-800 text-white'; // Darker, richer purple for active state
                    $inactiveClass = 'text-slate-300 hover:bg-slate-700 hover:text-white'; // Maintain sophisticated gray for inactive
                ?>
                <li>
                ...
                <li>
                    <a href="users.php" class="<?php echo ($activePage == 'users') ? $activeClass : $inactiveClass; ?> flex items-center px-4 py-3 rounded-md transition-colors duration-200">
                        <svg class="w-5 h-5 mr-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M15 19.5L12 22.5L9 19.5M12 2.5L12 20M4 17L4 7C4 5.89543 4.89543 5 6 5H18C19.1046 5 20 5.89543 20 7V17M4 17H20M4 17C4 18.1046 4.89543 19 6 19H18C19.1046 19 20 18.1046 20 17" /></svg>
    ...
    <main class="flex-1 p-6 lg:p-10">
        <header class="flex items-center justify-between mb-8">
            ...
            <a href="../logout.php" class="bg-red-700 hover:bg-red-800 text-white font-bold py-2 px-4 rounded-lg transition-colors duration-300">
                Logout
            </a>
        </header>